      ...
      orderItems: [
        {
          ...
          price: 5000,
          quantity: 2,
          image: "https://picsum.photos/150?random=154",
        },
      ],
    };
        ...
        <div className="p-4 md:p-6 rounded-lg border">
          ...
          <div className="flex flex-col sm:flex-row justify-between mb-8">
            ...
            <div className="flex flex-col items-start sm:items-end mt-4 sm:mt-0">
              ...
              <span
                ...
                `}
              >
                {!orderDetails.isPaid ? "Delivered" : "Pending Delivered"}
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
                ...
                <p><span className="font-bold">Shipping Method :</span> {orderDetails.shippingMethod}</p>
                <p><span className="font-bold">Address :</span> {`${orderDetails.shippingAddress.city}, ${orderDetails.shippingAddress.country}`}</p>
            </div>
          </div>
